...
export const FOOD_STAGES = [
  ...
  { id: 5, name: "牛丼", emoji: "🍲", calories: 700, radius: 44, color: "#A9622D" },
  { id: 6, name: "とんかつ", emoji: "🍖", calories: 900, radius: 52, color: "#C97B3D" },
  { id: 7, name: "焼肉", emoji: "🥩", calories: 1200, radius: 60, color: "#B5432A" },
  // あえてここで一度カロリーが下がる(コミカルな演出)
  { id: 8, name: "ラーメン", emoji: "🍜", calories: 700, radius: 68, color: "#E3B23C" },
  // 進化演出: 画面が揺れる、急激にサイズアップ
  { id: 9, name: "二郎系ラーメン", emoji: "🍜", badge: "💥", calories: 1500, radius: 80, color: "#D9772E", shakeOnSpawn: true },
  { id: 10, name: "二郎系マシマシ", emoji: "🍜", badge: "🧄", calories: 2500, radius: 90, color: "#2D4A3E" },
  { id: 11, name: "二郎系アブラカラメマシマシ全部増し", emoji: "🍜", badge: "🔥", calories: 3500, radius: 100, color: "#993C1D" },
  // 最終形態。実質1日の摂取カロリー相当として表示するための値(合体はここで終わり)
  { id: 12, name: "伝説の二郎", emoji: "🍜", badge: "👑", calories: 2200, radius: 112, color: "#D9AF3C", isFinal: true },
];
